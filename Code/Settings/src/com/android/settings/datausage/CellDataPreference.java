...
public class CellDataPreference extends CustomDialogPreference implements TemplatePreference {
    ...
    public void onAttached() {
        ...
        /// M: for op01 plug-in
        mDataUsageSummaryExt.onAttached(this);
    ...
    public void onDetached() {
        ...
        /// M: for op01 plugin
        mDataUsageSummaryExt.onDetached();
    }
    ...
    public void setTemplate(NetworkTemplate template, int subId, NetworkServices services) {
        ...
        /* SPRD: Bug 595087 only check default data sub @{ */
    ...
    protected void onClick(DialogInterface dialog, int which) {
        ...
        if (mMultiSimDialog) {
            ...
            if (!TelephonyUtils.isRadioOn(mSubId, getContext())){
                Toast.makeText(getContext(), R.string.deactivated_sim, Toast.LENGTH_SHORT).show();
                return;
            }
            /// @}
