...
public class OtherSoundSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    // modified by spro jzy for whether support WirelessCharging
    private static final SettingPref PREF_CHARGING_SOUNDS = new SettingPref(
        ...
        @Override
        public boolean isApplicable(Context context) {
            return hasChargingSettings(context);
        }
    };
    ...
    // added by spro jzy for whether support WirelessCharging
    private static boolean hasChargingSettings(Context context) {
        return context.getResources().getBoolean(R.bool.has_charging_settings);
    }
