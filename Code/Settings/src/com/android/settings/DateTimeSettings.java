...
public class DateTimeSettings extends SettingsPreferenceFragment
    ...
    public void updateTimeAndDateDisplay(Context context) {
        ...
        if (dateFormat != null && !dateFormat.equals("")) {
               ...
               Log.e("zfl","tempFormat =" +tempFormat);  
       }
       SimpleDateFormat mDateFormat=new SimpleDateFormat(tempFormat, l);
       //zfl ISU-2017-14267 20170509
		...
		mDatePref.setSummary(mDateFormat.format(now.getTime()));
		//zfl ISU-2017-14267 20170509
