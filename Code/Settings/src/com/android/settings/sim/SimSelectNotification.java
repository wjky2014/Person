...
public class SimSelectNotification extends BroadcastReceiver {
    ...
    private static boolean mDisplayDialog = false;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (subs != null) {
            for (int i = 0; i < subs.size(); ++i) {
                ...
                if (TextUtils.isEmpty(displayName) || (displayName.toString()).contains("CARD")) {
                    return;
                }
            }
        }
        ...
        Log.d(TAG, "sub info update, type = " + detectedType + ", subs = " + subs + "mDisplayDialog =" + mDisplayDialog);
        if (detectedType == SubscriptionManager.EXTRA_VALUE_NOCHANGE && mDisplayDialog) {
            return;
        }
