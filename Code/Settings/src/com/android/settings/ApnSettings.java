...
public class ApnSettings extends RestrictedSettingsFragment implements
    ...
    private void fillList() {
        ...
        */
        String order = "_id";//mApnExt.getApnSortOrder(Telephony.Carriers.DEFAULT_SORT_ORDER);
    ...
    public boolean shouldSkipApn(String type) {
        /// M: for plug-in
        return "cmmail".equals(type) || "emergency".equals(type) || "ims".equals(type) || !mRcseApnExt.isRcseOnlyApnEnabled(type);
    }
