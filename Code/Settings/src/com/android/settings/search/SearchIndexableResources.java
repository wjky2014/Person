...
public final class SearchIndexableResources {
    ...
    static {
        ...
        sResMap.put(SmartawakeSettings.class.getName(),
                new SearchIndexableResource(
                        Ranking.getRankForClassName(SmartawakeSettings.class.getName()),
                        R.xml.smart_awake,
                        SmartawakeSettings.class.getName(),
                        R.drawable.ic_settings_smart_awake));

		sResMap.put(SmartFeaturesSettings.class.getName(),
                new SearchIndexableResource(
                        Ranking.getRankForClassName(SmartFeaturesSettings.class.getName()),
                        R.xml.smart_features,
        ...
        sResMap.put(BackTouch.class.getName(),
                new SearchIndexableResource(
                        Ranking.getRankForClassName(BackTouch.class.getName()),
                        R.xml.back_touch,
