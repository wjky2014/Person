...
import com.android.settings.smartawake.SmartawakeSettings;
import com.android.settings.smartawake.SmartFeaturesSettings;
import com.android.settings.BackTouch;
...
public final class Ranking {
    ...
    //hj
    public static final int RANK_MANAGEAPP_SETTINGS = 24;
    public static final int RANK_MEMORY = 25;
    public static final int RANK_SMART_AWAKE = 26;
    public static final int RANK_NOTIFICATION_APPS = 27;
    public static final int RANK_BACK_TOUCH = 28;
	public static final int RANK_SMART_FEATURES = 29;
    ...
    static {
        ...
        //HJ
        sRankMap.put(ManageApplications.class.getName(), RANK_MANAGEAPP_SETTINGS);
        sRankMap.put(ProcessStatsSummary.class.getName(), RANK_MEMORY);
        sRankMap.put(SmartawakeSettings.class.getName(), RANK_SMART_AWAKE);
        sRankMap.put(NotificationApps.class.getName(), RANK_NOTIFICATION_APPS);
        sRankMap.put(BackTouch.class.getName(), RANK_BACK_TOUCH);
		sRankMap.put(SmartFeaturesSettings.class.getName(), RANK_SMART_FEATURES);
