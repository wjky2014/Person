...
import com.android.settingslib.bluetooth.LocalBluetoothManager;//zfl 20170611 BluetoothTether switch 
...
public class TetherSettings extends RestrictedSettingsFragment
    ...
    private AtomicReference<BluetoothPan> mBluetoothPan = new AtomicReference<BluetoothPan>();
	 private LocalBluetoothManager manager;//zfl
    ...
    public void onCreate(Bundle icicle) {
        ...
        manager = LocalBluetoothManager.getInstance(getActivity());//zfl 20170611 BluetoothTether switch 
        ...
        if (!bluetoothAvailable) {
            ...
            if (manager != null && manager.isTetheringOn()) {//zfl 20170611 BluetoothTether switch 
    ...
    private class TetherChangeReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context content, Intent intent) {
            ...
            if (action.equals(ConnectivityManager.ACTION_TETHER_STATE_CHANGED)) {
                ...
                /// @}
                updateState();
				//zfl ISU-2017-21002 20170622
				boolean newState = mUsbTether.isChecked();
				if(!mUsbConnected && newState){
				   //Log.e("zflzfl","mUsbTether.setEnabled(false)");
    ...
    private void updateBluetoothState(String[] available, String[] tethered,
        ...
        if (btState == BluetoothAdapter.STATE_TURNING_OFF) {
            ...
            if (btState == BluetoothAdapter.STATE_ON &&
                ...
                mBluetoothTether.setEnabled(!mDataSaverEnabled);
                //zfl 20170611 BluetoothTether switch 
