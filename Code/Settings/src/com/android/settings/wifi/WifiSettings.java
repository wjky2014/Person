...
public class WifiSettings extends RestrictedSettingsFragment
        ...
        switch (wifiState) {
            case WifiManager.WIFI_STATE_ENABLED:
                ...
                for (AccessPoint accessPoint : accessPoints) {
					...
					//android.util.Log.d("lili","accessPoint.getSsidStr()>>>"+accessPoint.getSsidStr());
                    if (accessPoint.getLevel() != -1) {
                        String key = accessPoint.getBssid();
						if(accessPoint!=null && accessPoint.getSsidStr().equals("NVRAM WARNING: Err = 0x10"))
							continue;
    ...
    private void setOffMessage() {
        ...
        //hj 2017/04/11 P5003M for scanning settings start
        /*if (!wifiScanningMode) {
        ...
        //}
        //hj 2017/04/11 P5003M for scanning settings end
