...
public class DisplaySettings extends SettingsPreferenceFragment implements
	...
	//*/Added by tangbaowen for one hand mode
    private static final String ONE_HAND_MODE_KEY="one_hand_mode";
    private static final String KEY_WALLPAPER = "wallpaper";
    private static final String KEY_VR_DISPLAY_PREF = "vr_display_pref";
    //SPRD: Bug#474450 Support the cutting function of  WifiDisplay module BEG -->
	...
	//*/Added by tangbaowen for one hand mode
    private SwitchPreference mToggleOneHandModePreference;
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		//*/Added by tangbaowen for one hand mode
        if(android.plugin.Features.JAVA_FEATURE_ONE_HAND){
            mToggleOneHandModePreference =
                (SwitchPreference) findPreference(ONE_HAND_MODE_KEY);
        }else{
            removePreference(ONE_HAND_MODE_KEY);
        }
    ...
    private void updateState() {
		...
		//*/Added by tangbaowen for one hand mode
		if(mToggleOneHandModePreference != null){
			final boolean oneHandModeEnabled = Settings.Secure.getInt(getContentResolver(),
                Settings.Secure.ONE_HAND_MODE, 0) != 0;
            mToggleOneHandModePreference.setChecked(oneHandModeEnabled);
		}
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
		...
		//*/Added by tangbaowen for one hand mode
        if (mToggleOneHandModePreference == preference) {
            handleToggleOneHandModePreferenceClick();
            return true;
        }//*/
	...
	//*/Added by tangbaowen for ond hand mode
    private void handleToggleOneHandModePreferenceClick() {
        Intent intent = new Intent();
        intent.setAction("sprocomm.intent.action.ONE_HAND_MODE");
        getActivity().sendBroadcast(intent);
        Settings.Secure.putInt(getContentResolver(),
                Settings.Secure.ONE_HAND_MODE,
                mToggleOneHandModePreference.isChecked() ? 1 : 0);
