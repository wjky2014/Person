...
public class SecuritySettings extends SettingsPreferenceFragment
    ...
    private void maybeAddFingerprintPreference(PreferenceGroup securityCategory, int userId) {
    	if(android.plugin.Features.JAVA_FEATURE_FINGER_TAB){
    		    Preference fingerprintTabPreference = NewBackTouchSetting.getBackTouchPreferenceForUser(securityCategory.getContext(), userId);
				if (fingerprintTabPreference != null) {
					securityCategory.addPreference(fingerprintTabPreference);
				}
    	}else{
    ...
    public static class SecuritySubSettings extends SettingsPreferenceFragment
        ...
        private void setupLockAfterPreference() {
            ...
            long currentTimeout = Settings.Secure.getLong(getContentResolver(),
                    Settings.Secure.LOCK_SCREEN_LOCK_AFTER_TIMEOUT, 30000);
